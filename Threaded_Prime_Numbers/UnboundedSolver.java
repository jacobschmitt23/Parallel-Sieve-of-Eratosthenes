...
/**
 * Unbounded Solver Sieve of Eratosthenes Solver
 * 
...
public class UnboundedSolver {
    ...
    /**
     * Menu display for the unbounded solver Sieve of Eratosthenes that allows input of the upper bound for the prime number calculations
     * 
    ...
    public void menu(Scanner scanner) {
        ...
        System.out.println("\nWelcome to the Unbounded Solver Sieve of Eratosthenes Solver");
    ...
    /**
     * Solves the Sieve of Eratosthenes in an unbounded solver manner
     * 
    ...
    private int solve(int num) {
        ...
        for (int i = 0; i < numThreads; i++) {
            Runnable task = new Task(rangeStart,rangeEnd);
        ...
        public void run() {
            for (int i = startRange; i < endRange; i++) {
                ...
                if (primes[i]) {
                    ...
                    synchronized (UnboundedSolver.this) {
